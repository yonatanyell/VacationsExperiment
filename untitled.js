...
psychoJS.start({
  ...
  resources: [
    ...
    {'name': '3.5.png', 'path': '3.5.png'},
    {'name': '3.png', 'path': '3.png'},
    {'name': '4.5.png', 'path': '4.5.png'},
    {'name': 'Book1.xlsx', 'path': 'Book1.xlsx'},
    {'name': '1.5.png', 'path': '1.5.png'},
    {'name': '2.png', 'path': '2.png'},
    {'name': '1.png', 'path': '1.png'},
    {'name': '2.5.png', 'path': '2.5.png'},
...
function trialsLoopBegin(trialsLoopScheduler, snapshot) {
  return async function() {
    ...
    trials = new TrialHandler({
      ...
      trialList: '/Users/yonatan.yellin/PycharmProjects/PsychoExp/Book1.xlsx',
