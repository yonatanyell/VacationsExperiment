...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/yonatan.yellin/PycharmProjects/PsychoExp/untitled_lastrun.py',
...
trials = data.TrialHandler(nReps=5.0, method='random', 
    ...
    trialList=data.importConditions('/Users/yonatan.yellin/PycharmProjects/PsychoExp/Book1.xlsx'),
